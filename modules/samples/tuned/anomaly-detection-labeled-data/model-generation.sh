...
path=$(pwd)
curl -X POST -b cookies  https://localhost:9443/api/datasets -H "Authorization: Basic YWRtaW46YWRtaW4=" -H "Content-Type: multipart/form-data" -F datasetName='wdbcSample' -F version='1.0.0' -F description='Wisconsin Diagnostic Breast Cancer Dataset' -F sourceType='file' -F destination='file' -F dataFormat='CSV' -F containsHeader='false' -F file=@'/'$path'/wdbcSample.csv' -k
sleep 5
...
project=$(curl -H "Content-Type: application/json" -H "Authorization: Basic YWRtaW46YWRtaW4=" -v https://localhost:9443/api/projects/wso2-ml-anomaly-detection-labeled-data-tuned-sample-project -k)
sleep 2
...
analysis=$(curl -H "Content-Type: application/json" -H "Authorization: Basic YWRtaW46YWRtaW4=" -v https://localhost:9443/api/projects/${projectId}/analyses/wso2-ml-anomaly-detection-labeled-data-tuned-sample-analysis -k)
sleep 2
...
curl -X POST -d @'hyper-parameters' -H "Content-Type: application/json" -H "Authorization: Basic YWRtaW46YWRtaW4=" -v https://localhost:9443/api/analyses/${analysisId}/hyperParams?algorithmName=K_MEANS_ANOMALY_DETECTION_WITH_LABELED_DATA -k -v
sleep 2
...
curl -X POST -H "Content-Type: application/json" -H "Authorization: Basic YWRtaW46YWRtaW4=" -v https://localhost:9443/api/models/${modelId}/predict?percentile=98 -k -v -d @'prediction-test'
