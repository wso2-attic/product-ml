...
public class AlgorithmPage extends MLUIPage {

    private static final Log logger = LogFactory.getLog(AlgorithmPage.class);
     ...
     */
    public AlgorithmPage(WebDriver driver) throws MLUIPageCreationException {
        super(driver);
    }
     ...
     */
    public ParametersPage next() throws InvalidPageException {
        try {
