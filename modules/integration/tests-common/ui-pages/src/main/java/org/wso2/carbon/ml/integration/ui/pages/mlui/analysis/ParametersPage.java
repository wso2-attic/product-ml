...
public class ParametersPage extends MLUIPage {

    private static final Log logger = LogFactory.getLog(ParametersPage.class);
     ...
     */
    public ParametersPage(WebDriver driver) throws MLUIPageCreationException {
        super(driver);
    }
     ...
     */
    public ModelPage next() throws InvalidPageException {
        try {
